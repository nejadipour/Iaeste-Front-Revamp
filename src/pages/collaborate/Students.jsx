    ...
    return (
        <>
            ...
            <div className="card-layout" style={{marginTop: 40}}>
                <Typography.Title level={4} style={{textAlign: 'center', margin: 0, marginBottom: 40}}>درخواست
                    همکاری</Typography.Title>
                <Typography.Title level={5} style={{margin: 0, marginBottom: 25}}>مشخصات درخواست
                    دهنده</Typography.Title>
                <Form layout="vertical" onFinish={handleSubmit}>
                    ...
                    <Button size="large" type="primary" style={{margin: '0 auto', display: 'block'}}>درخواست
                        همکاری</Button>
                </Form>
            </div>
        </>
